...
| **I-50** | **Los informes de `doc/` pueden ser obra derivada de los manuales de ST y de ARM, y el repositorio es público** | licencia, 2026-09-22 | **ABIERTO, y no se resuelve poniendo una licencia encima.** `doc/pdf/` está excluido del repositorio, que era lo evidente. Lo que no lo es: `informe_revisado.md` e `informe_instrucciones.md` salen de RM0090 y de la documentación de ARM. Los **hechos** —direcciones, máscaras, asignaciones de DMA— no son de nadie; la **expresión** sí, y un documento que sigue de cerca la estructura del manual y reproduce sus tablas puede ser derivado de él. **Solo se puede licenciar lo que es propio**, así que elegir GPLv3 no arregla esto. Las dos salidas honestas son reescribir lo que sea transcripción o sacarlo del repositorio público. Requiere leer los dos documentos con esa pregunta en la mano, cosa que nadie ha hecho todavía |
