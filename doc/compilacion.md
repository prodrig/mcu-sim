...
make test               # y la ejecuta: 1915 comprobaciones, código de salida 0/1
```
...
| Plataforma | Estado |
| :--- | :--- |
| Linux, g++ 13 | **Verificado**: 1915/1915, `make red` 13/13, ASan limpio |
