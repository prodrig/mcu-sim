...
Informe de implementación de la **fase F6** del plan `doc/smt32f407vg_diseño.md`.
Continúa a las fases F1-F5, que quedaron cerradas con el bxCAN
(`doc/stm32f407vg_fase5_can.md`).
Fuentes: `doc/informe_revisado.md` [IR, cap. 13] y `doc/informe_instrucciones.md` [II].
