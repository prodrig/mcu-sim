...
plan `doc/smt32f407vg_diseño.md` (§7). Continúa a `doc/stm32f407vg_fase3.md`
(pines, GPIO y RCC eléctrico), `doc/stm32f407vg_fase4_dma.md` (controladores
DMA) y `doc/stm32f407vg_fase4_uart.md` (interfaces serie). Fuentes:
...
`doc/stm32f407vg_fase4_uart.md`), y ya puede considerarse la **convención del
...
| `doc/stm32f407vg_fase4_tim.md` | este informe |
