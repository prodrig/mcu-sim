...
`doc/smt32f407vg_diseño.md` (§7). Continúa a `doc/smt32f407vg_fase0.md`,
`doc/stm32f407vg_fase1.md` (infraestructura y matriz AHB),
`doc/stm32f407vg_fase2.md` (núcleo Cortex-M4F) y `doc/stm32f407vg_fase3.md`
(pines, GPIO y RCC eléctrico). Fuentes: `doc/informe_revisado.md` [IR] y
