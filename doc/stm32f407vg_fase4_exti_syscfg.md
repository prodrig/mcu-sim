...
plan `doc/smt32f407vg_diseño.md` (§7), y **cierre de la fase F4**. Continúa a
`doc/stm32f407vg_fase4_dma.md` (controladores DMA),
`doc/stm32f407vg_fase4_uart.md` (interfaces serie) y
`doc/stm32f407vg_fase4_tim.md` (temporizadores). Fuentes:
...
| `doc/stm32f407vg_fase4_exti_syscfg.md` | este informe |
