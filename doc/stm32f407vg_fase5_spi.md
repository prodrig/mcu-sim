...
`doc/smt32f407vg_diseño.md` (§7). Continúa a los cuatro entregables de la fase
F4 (`doc/stm32f407vg_fase4_dma.md`, `_uart.md`, `_tim.md` y `_exti_syscfg.md`).
...
`doc/stm32f407vg_fase4_uart.md` §8 precisamente para hacerlo junto con el SPI,
...
(§1 de `doc/stm32f407vg_fase4_uart.md`) y en los temporizadores (§1 de
`doc/stm32f407vg_fase4_tim.md`); ya es la convención del proyecto:
...
| `doc/stm32f407vg_fase5_spi.md` | este informe |
...
`doc/stm32f407vg_fase4_uart.md` §8 dejó anotado que el USART aceptaba
