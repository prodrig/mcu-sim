...
Informe de implementación de la fase **F1** del plan `doc/smt32f407vg_diseño.md`
(§7). Continúa a `doc/smt32f407vg_fase0.md` (esqueleto y contrato de
integración). Fuentes: `doc/informe_revisado.md` [IR] y
...
| `src/Makefile.stm32` | Objetivos `test` y `run IMG=...`; incluye `verif/` en las dependencias |
