...
(`doc/stm32f407vg_fase6_gdb.md`) añadió un servidor GDB/RSP **soldado a los
...
```
./build/stm32f407vg --gdb     [--port=3333] [imagen.bin]   # sonda por los pines
./build/stm32f407vg --gdb-dap [--port=3333] [imagen.bin]   # stub interno al DAP
```
...
```
./build/stm32f407vg --gdb-dap --port=3401 verif/fw/test_isa.bin
```
