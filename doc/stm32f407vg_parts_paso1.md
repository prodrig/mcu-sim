...
completo y los cuatro pasos están en `doc/stm32f407vg_chat.md`, turno «Estrategia
XML + SVG de QtSysC».*
...
anteriores son de verdad: **el volcado del netlist**, `./build/stm32f407vg
--netlist`.
...
(`doc/stm32f407vg_coste_simulacion.md`). El banco de medida sigue dando **50
