...
| F5 | Resto de periféricos | **SPI/I2S, I2C, ADC, DAC, RTC, watchdogs, SDIO y CRC/RNG completados**; bxCAN pendiente |
| F6 | Debug (DAP/FPB/DWT/ITM), DBGMCU, trazas | pendiente |
| F7 | Bajo consumo, OTG/ETH/FSMC/DCMI, afinado AT | pendiente |

`make test` compila y ejecuta la suite de verificación acumulada (1137
...
65 de DAC, 94 de RTC y perros guardianes, 83 de SDIO y 67 de CRC/RNG de F5;
código de salida 0 si todas pasan, en unos 5 s). Verificado con SystemC 2.3.4 / g++ 13 / C++17
y arm-none-eabi-gcc 13.2.

Las pruebas T15-T17, T25, T31, T37, T43, T48, T55, T61, T66, T70, T79 y T82 necesitan los firmwares del repositorio; se
...
`make -C verif/fw/dac_demo`, `make -C verif/fw/sdio_demo` y
`make -C verif/fw/crc_rng_demo`
