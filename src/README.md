...
| F5 | Resto de periféricos | **SPI/I2S, I2C, ADC, DAC, RTC, watchdogs y SDIO completados**; CAN y CRC/RNG pendientes |
| F6 | Debug (DAP/FPB/DWT/ITM), DBGMCU, trazas | pendiente |
| F7 | Bajo consumo, OTG/ETH/FSMC/DCMI, afinado AT | pendiente |

`make test` compila y ejecuta la suite de verificación acumulada (1070
...
65 de DAC, 94 de RTC y perros guardianes y 83 de SDIO de F5; código de salida 0
si todas pasan, en unos 5 s). Verificado con SystemC 2.3.4 / g++ 13 / C++17
y arm-none-eabi-gcc 13.2.

Las pruebas T15-T17, T25, T31, T37, T43, T48, T55, T61, T66, T70 y T79 necesitan los firmwares del repositorio; se
...
`make -C verif/fw/dac_demo` y `make -C verif/fw/sdio_demo`
