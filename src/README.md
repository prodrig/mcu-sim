...
| F7 (resto) | ETH, afinado AT | pendiente |

`make test` compila y ejecuta la suite de verificación acumulada (1729
...
servidores GDB) + 344 de F7 (116 de bajo consumo, 61 del DCMI, 54 del FSMC y
113 del USB OTG);
código de
salida 0 si todas pasan, en unos 18 s). Verificado con SystemC 2.3.4 / g++ 13 / C++17
