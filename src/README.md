...
`make test` compila y ejecuta la suite de verificación acumulada (1234
...
65 de DAC, 94 de RTC y perros guardianes, 83 de SDIO, 67 de CRC/RNG y 97 de
bxCAN de F5; código de salida 0 si todas pasan, en unos 6 s). Verificado con SystemC 2.3.4 / g++ 13 / C++17
y arm-none-eabi-gcc 13.2.

Las pruebas T15-T17, T25, T31, T37, T43, T48, T55, T61, T66, T70, T79, T82 y T88 necesitan los firmwares del repositorio; se
...
`make -C verif/fw/crc_rng_demo` y `make -C verif/fw/can_demo`
