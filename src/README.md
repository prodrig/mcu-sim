...
| F7 (resto) | OTG/ETH, afinado AT | pendiente |

`make test` compila y ejecuta la suite de verificación acumulada (1616
...
servidores GDB) + 231 de F7 (116 de bajo consumo, 61 del DCMI y 54 del FSMC);
código de
