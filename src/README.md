...
`make test` compila y ejecuta la suite de verificación acumulada (216
comprobaciones autocomprobables: 124 de F1 + 12 de F2 + 80 de F3; código de
salida 0 si todas pasan, en unos 2 s). Verificado con SystemC 2.3.4 / g++ 13 /
C++17 y arm-none-eabi-gcc 13.2.

Las pruebas T15-T17 y T25 necesitan los firmwares del repositorio; se compilan
con `make -C verif/fw`, `make -C verif/fw/coremark` y `make -C verif/fw/blinky`
