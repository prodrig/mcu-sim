...
| F7 (resto) | OTG/ETH/FSMC, afinado AT | pendiente |

`make test` compila y ejecuta la suite de verificación acumulada (1562
...
servidores GDB) + 177 de F7 (116 de bajo consumo y 61 del DCMI); código de
salida 0 si todas pasan, en unos 13 s). Verificado con SystemC 2.3.4 / g++ 13 / C++17
